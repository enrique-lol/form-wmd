...
import { getArticle, articleUpdate } from './../api/article-api.js'
...
class UpdateArticle extends Component {
  ...
  handleSubmit = (event) => {
    ...
    articleUpdate(match.params.id, article)
  ...
  render () {
    ...
    if (!article) {
      ...
      return <Fragment><Redirect to={`/article/${this.props.match.params.id}`}/></Fragment>
    }
    return (
      <Fragment>
        <ArticleForm
